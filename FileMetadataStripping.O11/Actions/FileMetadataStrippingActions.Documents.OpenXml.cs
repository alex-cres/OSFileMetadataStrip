...
{
    // Office Open XML (DOCX / XLSX / PPTX and template variants) and Word 2003 XML
    // (WordProcessingML) strip pipelines. Both are Microsoft Word document surfaces
    // sharing <o:*> property groups and w:author scrubbing semantics.
    ...
    private static RecFileMetadataResult StripWordMlMetadata(byte[] rawFile, bool stripBodyAuthors)
    {
        try
        {
            XDocument xdoc;
