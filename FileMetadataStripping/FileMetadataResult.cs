...
public struct FileMetadataResult
{
    ...
    [OSStructureField(Description = "JSON object of the metadata entries found and removed. Keys vary by format: images use exif/iptc/xmp; PDFs use title/author/subject/keywords/creator/producer; OOXML core properties use creator/lastModifiedBy/created/modified/title/subject/description/keywords/category/revision; OOXML app properties use appApplication/appCompany/appManager/appVersion/appTemplate; OOXML custom properties appear under customProperties; author names from tracked changes and comments appear in strippedAuthors; audio/video use the tag fields present in the file. Returns '[]' when no metadata was found.")]
