...
public struct FileMetadataResult
{
    ...
    [OSStructureField(Description = "JSON object of the metadata entries found and removed. Keys vary by format: images use exif/iptc/xmp; PDFs use title/author/subject/keywords/creator/producer; OOXML documents use creator/lastModifiedBy/created/modified/title/subject/description/keywords/category/revision; audio/video use the tag fields present in the file. Returns '[]' when no metadata was found. Contains a processingError key when an audio/video file could not be parsed by the media engine.")]
