...
public partial class FileMetadataStripping
{
    ...
    private static readonly System.Text.RegularExpressions.Regex RtfMetadataControlWord = new(
    ...
    private static FileMetadataResult StripRtfMetadata(byte[] rawFile)
    {
        try
        {
