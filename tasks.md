...
6. Fix animated GIF and multi-frame TIFF support — switch StripImageMetadata from MagickImage to MagickImageCollection so all frames are preserved after stripping
7. Strip PDF XMP metadata streams (catalog /Metadata entry) in addition to the /Info dictionary
