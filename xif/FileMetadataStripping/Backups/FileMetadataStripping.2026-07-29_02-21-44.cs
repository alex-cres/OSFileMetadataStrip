...
namespace OutSystems.NssFileMetadataStripping {
	...
	public partial class CssFileMetadataStripping : IssFileMetadataStripping {
		...
		/// <summary>
		/// Strips metadata from a file. Supports images (EXIF/IPTC/XMP), SVG (title/desc/metadata), PDFs, OOXML (DOCX/XLSX/PPTX), ODF (ODT/ODS/ODP), EPUB, ORA (Open Raster), and audio/video (MP3/WAV/FLAC/OGG/MP4/MKV/AVI). Unrecognised formats returned unchanged with IsPassthrough=true.
		/// </summary>
