...
namespace OutSystems.NssFileMetadataStripping {
    ...
    public class CssFileMetadataStripping : IssFileMetadataStripping {
        ...
        /// <summary>
        /// Strips metadata from a file. Supports images (EXIF/IPTC/XMP), PDFs, OOXML (DOCX/XLSX/PPTX),
        /// ODF (ODT/ODS/ODP), and audio/video (MP3/WAV/FLAC/OGG/MP4/MKV/AVI).
        ...
        private static RCFileMetadataResultRecord StripPdfMetadata(byte[] rawFile)
        {
                ...
                ex is NotSupportedException)
            {
                ...
                var errR = new RCFileMetadataResultRecord(null);
                errR.ssSTFileMetadataResult.ssCleanFile         = rawFile;
                errR.ssSTFileMetadataResult.ssExtractedMetadata = note.ToJsonString();
                errR.ssSTFileMetadataResult.ssRemovedEntryCount = 0;
                errR.ssSTFileMetadataResult.ssIsPassthrough     = false;
                return errR;
            }
            ...
            using (document)
            {
                ...
                var r = new RCFileMetadataResultRecord(null);
                r.ssSTFileMetadataResult.ssCleanFile         = outputMs.ToArray();
                r.ssSTFileMetadataResult.ssExtractedMetadata = extractedMetadata;
                r.ssSTFileMetadataResult.ssRemovedEntryCount = removedEntryCount;
                r.ssSTFileMetadataResult.ssIsPassthrough     = false;
                return r;
        ...
        private static RCFileMetadataResultRecord StripOpenXmlMetadata(byte[] rawFile, bool stripBodyAuthors)
        {
            try
            {
                ...
                if (partWrites.Count > 0)
                {
                    ...
                    var r1 = new RCFileMetadataResultRecord(null);
                    r1.ssSTFileMetadataResult.ssCleanFile         = zipMs.ToArray();
                    r1.ssSTFileMetadataResult.ssExtractedMetadata = count > 0 ? root.ToJsonString() : "[]";
                    r1.ssSTFileMetadataResult.ssRemovedEntryCount = count;
                    r1.ssSTFileMetadataResult.ssIsPassthrough     = false;
                    return r1;
                }

                var r2 = new RCFileMetadataResultRecord(null);
                r2.ssSTFileMetadataResult.ssCleanFile         = ms.ToArray();
                r2.ssSTFileMetadataResult.ssExtractedMetadata = count > 0 ? root.ToJsonString() : "[]";
                r2.ssSTFileMetadataResult.ssRemovedEntryCount = count;
                r2.ssSTFileMetadataResult.ssIsPassthrough     = false;
                return r2;
            }
            catch (Exception ex) when (
