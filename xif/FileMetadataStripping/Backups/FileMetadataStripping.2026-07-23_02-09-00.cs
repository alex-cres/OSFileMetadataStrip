	...
	public class CssFileMetadataStripping : IssFileMetadataStripping {
		...
		private static RCFileMetadataResultRecord StripPdfMetadata(byte[] rawFile)
		{
				...
				ex is NotSupportedException)
			{
				...
				var rErr = new RCFileMetadataResultRecord(null);
				rErr.ssSTFileMetadataResult.ssCleanFile         = rawFile;
				rErr.ssSTFileMetadataResult.ssExtractedMetadata = note.ToJsonString();
				rErr.ssSTFileMetadataResult.ssRemovedEntryCount = 0;
				rErr.ssSTFileMetadataResult.ssIsPassthrough     = false;
				return rErr;
			}
		...
		private static RCFileMetadataResultRecord StripOpenXmlMetadata(byte[] rawFile)
		{
			try
			{
